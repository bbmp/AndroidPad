...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.common_CircleImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.common_CircleImageView_common_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.common_CircleImageView_common_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.common_CircleImageView_common_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.common_CircleImageView_common_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
