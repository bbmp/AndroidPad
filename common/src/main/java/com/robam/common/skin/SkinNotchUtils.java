...
public class SkinNotchUtils {
    ...
    public static boolean hasNotchInVivo(Context context) {
        ...
        try {
            ...
            LogUtils.e("hasNotchInVivo ClassNotFoundException");
        } catch (Exception e) {
            LogUtils.e("hasNotchInVivo Exception");
        }
        return ret;
    }
    ...
    public static boolean hasNotchInHuawei(Context context) {
        ...
        try {
            ...
            LogUtils.e("hasNotchInHuawei ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            LogUtils.e("hasNotchInHuawei NoSuchMethodException");
        } catch (Exception e) {
            LogUtils.e("hasNotchInHuawei Exception");
        }
        return hasNotch;
    }
    ...
    public static int[] getNotchSizeInHuawei(Context context) {
        if (sNotchSizeInHawei == null) {
            ...
            try {
                ...
                LogUtils.e("getNotchSizeInHuawei ClassNotFoundException");
            } catch (NoSuchMethodException e) {
                LogUtils.e("getNotchSizeInHuawei NoSuchMethodException");
            } catch (Exception e) {
                LogUtils.e("getNotchSizeInHuawei Exception");
            }
