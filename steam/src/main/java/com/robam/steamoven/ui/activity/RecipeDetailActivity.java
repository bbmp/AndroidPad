...
import com.robam.steamoven.response.GetRecipeDetailRes;
...
public class RecipeDetailActivity extends SteamBaseActivity {
    ...
    private SteamDialogFactory selectStoveDialog;
        ...
        AccountInfo.getInstance().getGuid().observe(this, new Observer<String>() {
            ...
            public void onChanged(String s) {
                for (Device device: AccountInfo.getInstance().deviceList) {
                    if (device.guid.equals(s) && device.guid.equals(HomeSteamOven.getInstance().guid) && device instanceof Stove) { //当前灶
...
//初始值
    ...
    private void setData(StoveRecipeDetail stoveRecipeDetail) {
        ...
        //时间
        ivTime.setImageResource(R.drawable.steam_time);
        //图片
        ...
        //步骤
        ArrayList<RecipeStep2> recipeSteps = new ArrayList<>();
