...
//                                short orderRightMinutes = ByteUtils.toShort(payload[offset + 1]);
//                                msg.putOpt(SteamConstant.orderRightMinutes, orderRightMinutes);
//                            }else if (steamOvenHeader_Length==3){
//                                short orderRightMinutes = ByteUtils.toShort(payload[offset + 1]);
//                                msg.putOpt(SteamConstant.orderRightMinutes, orderRightMinutes);
//
//                                short orderLeftMinutes1 = ByteUtils.toShort(payload[offset + 2]);
//                                msg.putOpt(SteamConstant.orderLeftMinutes1, orderLeftMinutes1);
//
//
...
//                                msg.putOpt(SteamConstant.orderLeftMinutes1, orderLeftMinutes1);
//
//                                short orderRightMinutes1 = ByteUtils.toShort(payload[offset + 3]);
//                                msg.putOpt(SteamConstant.orderRightMinutes1, orderRightMinutes1);
//                            }
                            break;
                        case 7:
...
//                Log.e("结果","------------"+arg1);
//                msg.putOpt(SteamConstant.faultCode, arg1);
