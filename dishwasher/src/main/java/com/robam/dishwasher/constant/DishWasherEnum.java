...
public enum DishWasherEnum {
    ...
    AUTO_AERATION(DishWasherConstant.MODE_AUTO_AERATION,"自动换气"),
    AUTO_AERATION_AWAIT(DishWasherConstant.MODE_AUTO_AERATION_AWAIT,"自动换气"),//自动换气等待
    ...
    FLUSH_AWAIT(DishWasherConstant.MODE_FLUSH_AWAIT,"护婴净存"),//护婴净存等待
    LONG_STORAGE(DishWasherConstant.MODE_LONG_STORAGE,"长效净存"),
    LONG_STORAGE_AWAIT(DishWasherConstant.MODE_LONG_STORAGE_AWAIT,"长效净存");//长效净存等待
