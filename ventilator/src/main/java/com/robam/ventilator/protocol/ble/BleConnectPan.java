...
public class BleConnectPan {
    ...
    public static void startScan(BleVentilator.BleCallBack bleCallBack) {
        ...
        BlueToothManager.startScan(new BleScanCallback() {
            ...
            public void onScanStarted(boolean success) {
                LogUtils.e("Pan onScanStarted");
            }

            @Override
            public void onLeScan(BleDevice bleDevice) {
                super.onLeScan(bleDevice);
                LogUtils.e("Pan onLeScan " + bleDevice.getName());
            }
    ...
    public static void connect(final BleDevice bleDevice, WeakReference<BleVentilator.BleCallBack> bleCallBackWeakReference) {
        LogUtils.e("Pan connect " + bleDevice.getMac() + " " + bleDevice.getName() + " rssi " + bleDevice.getRssi());
        BlueToothManager.connect(bleDevice, new BleGattCallback() {
            @Override
            public void onStartConnect() {
                LogUtils.e("Pan onStartConnect");
            }

            @Override
            public void onConnectFail(BleDevice bleDevice, BleException exception) {

                LogUtils.e("Pan onConnectFail " + exception.getDescription());
                if (null != bleCallBackWeakReference && null != bleCallBackWeakReference.get())
            ...
            public void onConnectSuccess(BleDevice bleDevice, BluetoothGatt gatt, int status) {
                LogUtils.e("Pan onConnectSuccess " + bleDevice.getName());
                //设置mtu
//                BlueToothManager.setMtu(bleDevice);
                //连接成功
                BleVentilator.addSubDevice(IDeviceType.RZNG, bleDevice);
