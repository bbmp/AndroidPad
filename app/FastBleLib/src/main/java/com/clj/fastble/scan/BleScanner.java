...
//    };
    ...
    private final ScanCallBackPresenter mBleScanPresenter = new ScanCallBackPresenter() {
...
//                .startLeScan(serviceUuids, mBleScanPresenter);
        ...
        BleManager.getInstance().getBluetoothAdapter().getBluetoothLeScanner().startScan(Collections.singletonList(new ScanFilter.Builder().build()), new ScanSettings.Builder().build(), mBleScanPresenter);
    ...
    public synchronized void stopLeScan() {
        Log.e("BleVentilator","onLeScan stopLeScan");
