...
public abstract class ScanCallBackPresenter extends ScanCallback {
    ...
    private static final class ScanHandler extends Handler {
        ...
        private final WeakReference<ScanCallBackPresenter> mBleScanPresenter;

        ScanHandler(Looper looper, ScanCallBackPresenter bleScanPresenter) {
            super(looper);
        ...
        public void handleMessage(Message msg) {
            ScanCallBackPresenter bleScanPresenter = mBleScanPresenter.get();
    ...
    public void prepare(String[] names, String mac, boolean fuzzy, boolean needConnect,
        ...
        mHandlerThread = new HandlerThread(ScanCallBackPresenter.class.getSimpleName());
    ...
    public void onBatchScanResults(List<ScanResult> results) {
        if(results != null){
            for(ScanResult item : results){
                onLeScan(item.getDevice(),item.getRssi(),item.getScanRecord().getBytes());
            }
        }
    }
