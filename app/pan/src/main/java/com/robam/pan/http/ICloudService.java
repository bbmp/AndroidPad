...
//    String getPotPCookPage = "/rest/cks/api/smart-pan/page";
    String getPotPCookPage = "/rest/cook/api/smart-pan/page";
    //获取//烹饪曲线列表
...
//    String cookingCurveMarkStep = "/rest/cks/api/curve_cookbook/v2/cooking_curve/markStep"; //更新标记步骤
    ...
    @GET(getPotPCookPage)
    Call<ResponseBody> getPotPCookPage(@Query("deviceGuid") String guid , @Query("cookName") String cookName , @Query("pageIndex") Integer pageNo , @Query("pageSize") Integer pageSize);
