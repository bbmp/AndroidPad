package com.robam.common.ui.blurview;
...
import com.robam.common.ui.blurview.enu.BlurCorner;
import com.robam.common.ui.blurview.enu.BlurMode;
import com.robam.common.ui.blurview.impl.AndroidStockBlurImpl;
import com.robam.common.ui.blurview.impl.AndroidXBlurImpl;
    ...
    public ShapeBlurView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            float cornerRadiusOverride =
                    a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_corner_radius, -1);
            mCornerRadii[BlurCorner.TOP_LEFT] =
                    a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_corner_radius_top_left, -1);
            mCornerRadii[BlurCorner.TOP_RIGHT] =
                    a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_corner_radius_top_right, -1);
            mCornerRadii[BlurCorner.BOTTOM_RIGHT] =
                    a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_corner_radius_bottom_right, -1);
            mCornerRadii[BlurCorner.BOTTOM_LEFT] =
                    a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_corner_radius_bottom_left, -1);
            initCornerData(cornerRadiusOverride);
            blurMode = a.getInt(R.styleable.common_ShapeBlurView_common_blur_mode, BlurMode.MODE_RECTANGLE);

            mBorderWidth = a.getDimensionPixelSize(R.styleable.common_ShapeBlurView_common_blur_border_width, -1);
            if (mBorderWidth < 0) {
                mBorderWidth = DEFAULT_BORDER_WIDTH;
            }
            mBorderColor = a.getColorStateList(R.styleable.common_ShapeBlurView_common_blur_border_color);
...
//    }
    ...
    public void setScale(float scale) {
        if (scale <= 0) {
            throw new IllegalArgumentException("DownSample scale must be greater than 0.");
        }
...
//    }
    ...
    protected boolean prepare() {
        ...
        final int width = (int) (getWidth() * mScale);
    ...
    private final ViewTreeObserver.OnPreDrawListener preDrawListener = new ViewTreeObserver.OnPreDrawListener() {
        ...
        public boolean onPreDraw() {
            ...
            if (decor != null && isShown() && prepare() && getVisibility() == View.VISIBLE) {
                ...
                RENDERING_COUNT++;
                try {
                    mBlurringCanvas.scale(1.f * mBitmapToBlur.getWidth() / (getWidth()*mScale), 1.f * mBitmapToBlur.getHeight() / (getHeight()*mScale));
