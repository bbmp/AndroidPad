...
public final class SwitchButton extends View {
    ...
    /** 开启状态背景色 */
    protected int mAccentColor = 0xFF5A8DDF;
    /** 开启状态按钮描边色 */
    protected int mPrimaryDarkColor = 0xFF5A8DDF;
    /** 关闭状态描边色 */
    ...
    public SwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.common_SwitchButton);
        mChecked = array.getBoolean(R.styleable.common_SwitchButton_android_checked, mChecked);
        setEnabled(array.getBoolean(R.styleable.common_SwitchButton_android_enabled, isEnabled()));
