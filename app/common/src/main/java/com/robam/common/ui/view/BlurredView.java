...
import com.robam.common.utils.BlurBitmap;
import com.robam.common.utils.BlurredUtil;
...
public class BlurredView extends RelativeLayout {
    ...
    private void init(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.common_blurredview, this);
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.common_BlurredView);
        Drawable drawable = typedArray.getDrawable(R.styleable.common_BlurredView_common_src);
        isMove = typedArray.getBoolean(R.styleable.common_BlurredView_common_move, false);
        isDisableBlurred = typedArray.getBoolean(R.styleable.common_BlurredView_common_disableBlurred, false);
