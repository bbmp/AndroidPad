...
public class FileUtils {
    ...
    public static boolean copyFile(String srcPath, String destDir){
        ...
        if (!srcFile.exists()){
            LogUtils.i("FileUtils is copyFile：file not exist");
            return false;
        }
        // 获取待复制文件的文件名
        ...
        if (destPath.equals(srcPath)){
            LogUtils.i("FileUtils is copyFile：path equals");
            return false;
        }
        File destFile = new File(destPath); // 目标文件
        if (destFile.exists() && destFile.isFile()){
            LogUtils.i("FileUtils is copyFile：same file");
            return false;
        }
    ...
    public static boolean renameTo(String oldPath, String newPath){
        if (oldPath.equals(newPath)){
            LogUtils.i("FileUtils is renameTo：same path");
            return false;
        }
