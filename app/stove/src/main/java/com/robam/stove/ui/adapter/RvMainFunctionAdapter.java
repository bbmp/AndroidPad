...
public class RvMainFunctionAdapter extends BaseQuickAdapter<StoveFunBean, BaseViewHolder> {
...
//    private RequestOptions options = RequestOptions.bitmapTransform(new MultiTransformation(new BlurTransformation(30, 3)));
    ...
    public RvMainFunctionAdapter() {
        super(R.layout.stove_item_main_function);
    }
    ...
    @Override
    public StoveFunBean getItem(int position) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder baseViewHolder, StoveFunBean stoveFunBean) {
